...
```{r Figure-2, echo=FALSE,fig.height=3.5, fig.width=6, fig.pos="!H", fig.cap= "\\label{fig:sens_plot}Graphical representation of the sensitivity analysis results  presented in Figure 1 (Section 5)."}
sens_plot
```
